...
def loadData(dir):
    ...
    with h5py.File(str(dir),'r') as h5f:
        ...
        print('==============================================================\n')
        features = h5f['features'][:][div_timesteps*n:div_timesteps*n+div_timesteps]
        labels = h5f['labels'][:][div_timesteps*n:div_timesteps*n+div_timesteps]
        h5f.close()
...
if __name__ == '__main__':
    ...
    plt.figure(1)
    plt.title('Thrust Delivered By Motor')
