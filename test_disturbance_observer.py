...
output_indices = np.arange(27,33).tolist()
...
predictions = np.zeros((total_predictions+33*batchsize,3))
...
plt.plot(test_dataset[27,:],'-', mew=1, ms=8,mec='w')
...
plt.plot(test_dataset[28,:],'-', mew=1, ms=8,mec='w')
plt.grid()
...
plt.plot(test_dataset[29,:],'-', mew=1, ms=8,mec='w')
# plt.title('Yaw Rate')
plt.grid()
# plt.xticks(graph_ticks_spacing, graph_ticks_words )
plt.xlabel('time - [s]')
...
# plt.plot(test_dataset[30,:],'-', mew=1, ms=8,mec='w')
...
# plt.plot(test_dataset[31,:],'-', mew=1, ms=8,mec='w')
# plt.grid()
...
# plt.plot(test_dataset[32,:],'-', mew=1, ms=8,mec='w')
# plt.grid()
